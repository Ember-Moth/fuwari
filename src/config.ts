...
export const siteConfig: SiteConfig = {
	title: "Ember Moth",
	subtitle: "Fight for All That is Beautiful in the World！",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/Ember-Moth", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			...
			url: "https://github.com/Ember-Moth",
		},
	],
};
